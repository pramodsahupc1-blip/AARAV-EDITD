...
import heroImg from "../assets/images/regenerated_image_1782051624074.jpg";

export function Hero() {
  return (
    <section id="home" className="min-h-screen relative flex items-center pt-20 overflow-hidden">
      {/* Background glow effects */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[120px] -z-10 pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-purple-900/20 rounded-full blur-[100px] -z-10 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-block px-4 py-1.5 rounded-full glass text-sm font-bold tracking-widest text-blue-500 mb-6 border border-blue-500/30 uppercase">
            Editing, App Development & Web Solutions
          </div>
          ...
          <div className="relative aspect-square max-w-[500px] mx-auto">
            ...
            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[120%] text-center z-20 transform -rotate-6">
              <span className="font-sans font-black text-6xl md:text-8xl text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.8)] tracking-tighter italic">
                AARAV <span className="text-blue-500">EDITS</span>
              </span>
              <div className="font-sans font-black text-4xl md:text-6xl text-blue-500 drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)] tracking-widest italic mt-[-10px]">
                001
              </div>
            </div>
          </div>
